"""Fine-tune the seatbelt detector (seatbelt_absent / seatbelt_present).

Starts from ``yolo11n.pt`` and fine-tunes on ``datasets/seatbelt_data`` using the
...
-----
    ...
    python train/finetune_seatbelt.py --device cuda:0
"""
...
def main(argv: Optional[List[str]] = None) -> None:
    """Parse CLI args and fine-tune the seatbelt model."""
    parser = argparse.ArgumentParser(description="Fine-tune the seatbelt detector.")
    ...
    logger.info("Seatbelt fine-tuning complete: %s", result["weights"])
